...
export const dictionaries: Record<Locale, Dictionary> = {
  en: {
    ...
    searchTitle: "Find source passages",
    searchCopy:
      "Find matching passages from your books without creating an AI answer.",
    searchLabel: "Words or phrase",
    ...
    sourcePassagesTitle: "Source passages only",
    askAiWithThisQuestion: "Ask AI with this question",
  ...
  de: {
    ...
    searchTitle: "Quellenstellen finden",
    searchCopy:
      "Finde passende Textstellen aus deinen Büchern, ohne eine KI-Antwort zu erstellen.",
    searchLabel: "Wörter oder Ausdruck",
    ...
    sourcePassagesTitle: "Nur Quellenstellen",
    askAiWithThisQuestion: "KI mit dieser Frage fragen",
