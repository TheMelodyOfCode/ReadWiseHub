...
export const dictionaries: Record<Locale, Dictionary> = {
  en: {
    ...
    billingCopy: "Upgrade with Stripe test checkout or manage an existing Stripe subscription.",
  ...
  de: {
    ...
    billingCopy: "Upgrade per Stripe-Test-Checkout oder verwalte ein bestehendes Stripe-Abo.",
    ...
    billingTestMode: "Stripe-Abos bleiben im Testaufbau, bis Checkout- und Webhook-Lifecycle geprüft sind.",
