...
export const dictionaries: Record<Locale, Dictionary> = {
  en: {
    ...
    helpUploadCopy:
      "Upload PDF, TXT, Markdown, DOCX, or EPUB files. Processing status appears on each book card and the app warns you when extracted text quality is limited.",
    helpAskTitle: "Ask",
    helpAskCopy:
    ...
    helpVectorCopy:
      "ReadWiseHub uses extracted text first and can use vector retrieval where coverage is ready. If a book has incomplete vector coverage, the app falls back to the stored text.",
    ...
    uploadProcessing: "Processing document - Please wait",
  ...
  de: {
    ...
    helpUploadTitle: "Upload",
    helpUploadCopy:
      "Lade PDF, TXT, Markdown, DOCX oder EPUB hoch. Der Verarbeitungsstatus steht direkt auf jeder Buchkarte und die App warnt dich bei begrenzter Textqualität.",
    helpAskTitle: "Fragen",
    helpAskCopy:
    ...
    helpVectorCopy:
      "ReadWiseHub nutzt zuerst extrahierten Text und kann Vektorsuche verwenden, wo die Abdeckung bereit ist. Bei unvollständiger Abdeckung fällt die App auf gespeicherten Text zurück.",
    ...
    uploadProcessing: "Dokument wird verarbeitet - Bitte warten",
